...
func main() {
	...
	// Validate CloudSigma credentials
	if cloudsigmaUsername == "" || cloudsigmaPassword == "" {
		setupLog.Error(nil, "CloudSigma credentials are required. Set CLOUDSIGMA_USERNAME and CLOUDSIGMA_PASSWORD environment variables or use flags.")
		os.Exit(1)
	}
	...
	setupLog.Info("Starting CAPCS", "region", cloudsigmaRegion)
